...
int InitGL(GLvoid)										// All Setup For OpenGL Goes Here
{
	...
	DrawableModel* m = DrawableModelLoader::LoadOBJModel(filename);
	ShipGUIController* controller = new ShipGUIController(m);
	ShipView* ship = new ShipView(m, controller);
	shipView = new ShipViewport(ship);
